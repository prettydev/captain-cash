...
//     id: 2,
//     text: "Card #2",
//     url: "https://pbs.twimg.com/profile_images/681369932207013888/CHESpTzF.jpg",
//     name: "Ceyhun",
//     age: "25",
...
//     id: 3,
//     text: "Card #3",
//     url: "https://c1.staticflickr.com/6/5252/5403292396_0804de9bcf_b.jpg",
//     name: "Özge",
//     age: "29",
...
//     id: 4,
//     text: "Card #4",
//     url: "https://pbs.twimg.com/media/BduTxWnIUAAKT_5.jpg",
//     name: "Özlem",
//     age: "33",
...
//     id: 5,
//     text: "Card #5",
//     url: "https://c1.staticflickr.com/8/7175/6698567177_fc5df89f18_b.jpg",
//     name: "Eren",
//     age: "31",
//     school: "Bahçeşehir Üniversitesi",
//     distance: "5"
...
class SwipeScreen extends Component {
  ...
  constructor(props) {
    ...
    this.recommendationBatchLimit = 25;
  ...
  updateUserFriendsCollection = (friends, newMatches) => {
    this.userRef
      ...
      .then(() => {
        this.updateAppUserData();
        this.updateFriendshipsCollection(newMatches);
      })
  ...
  updateAppUserData = () => {
    this.getGivenUserData(this.props.user.id, user => {
  ...
  filterUsersForRecommendation = async (
    ...
    console.log("shouldShowMe==", shouldShowMe);
            ...
            {(this.state.loadedDeck ||
              ...
              <Deck
                ...
                onSwipe={(direction, item, index) =>
                  this.onSwipe(direction, item, index)}
                showMode={this.state.showMode}/>
            )}
            <ActivityModal
              loading={this.state.loadedDeck === false &&
                this.state.recommendations.length === 0}
              title={"Please wait"}
              size={"large"}
              activityColor={"white"}
